  ...
  return (
    <div className="bg-[#F2F2F2] min-h-screen text-[#014E87]">
      ...
      <section className="relative overflow-hidden bg-[#014E87] text-white">
        ...
        {/* Mascot silhouette — one fluid right-edge treatment across all breakpoints
            (previously two mutually-exclusive divs swapped discontinuously at `lg`,
            which made the hero look like a different layout on either side of 1024px) */}
        <div
          aria-hidden="true"
          className="absolute right-0 bottom-0 top-0 w-[65%] sm:w-[55%] md:w-[46%] lg:w-[38%] bg-cover bg-right-bottom opacity-30 sm:opacity-50 md:opacity-70 lg:opacity-90 pointer-events-none transition-opacity"
          style={{
