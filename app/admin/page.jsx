...
function AdminDashboardInner() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        /* Supabase not configured — leave blank */
      }
    })();
  }, []);
  ...
  const exportCsv = async () => {
    try {
      // Session travels via cookies automatically (same-origin fetch) — no
      // bearer token needed now that auth is Supabase-session-based.
